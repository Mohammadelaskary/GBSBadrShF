...
public PaintWipAdapter(List<StationsWIP> stationwipresponse) {
...
public PaintWipAdapter.PaintWipViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new PaintWipAdapter.PaintWipViewHolder(machinewipLstBinding);
        }
...
class PaintWipViewHolder extends RecyclerView.ViewHolder {
    ...
    public PaintWipViewHolder(@NonNull MachinewipLstBinding itemView) {
