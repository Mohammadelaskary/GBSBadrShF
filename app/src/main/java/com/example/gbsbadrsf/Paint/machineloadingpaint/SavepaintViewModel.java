...
public class SavepaintViewModel extends ViewModel {
    ...
    void savepaintloading(String UserId,String DeviceSerialNo,String ProductionStationCode,String BsketCode,String loadinyqty,String  JoborderId,String parentid){
