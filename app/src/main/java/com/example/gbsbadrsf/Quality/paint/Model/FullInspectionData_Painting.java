...
public class FullInspectionData_Painting {
    ...
    public FullInspectionData_Painting(Integer userId, String deviceSerialNo, String basketCode, String defectedBasketCode, String rejectedBasketCode, List<OkBasketLst> okBasketLst, Boolean isBulkQty) {
        this.userId = userId;
