...
public class UpdateWeldingDefectsData {
    ...
    public UpdateWeldingDefectsData(Integer userId, String deviceSerialNo, Integer defectGroupId, Integer qtyDefected, List<Integer> defectList, Boolean isBulkGroup, Boolean isRejected) {
        this.userId = userId;
