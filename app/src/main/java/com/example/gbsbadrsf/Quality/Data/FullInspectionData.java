...
public class FullInspectionData {
    ...
    public FullInspectionData(Integer userId, String deviceSerialNo, String basketCode, String defectedBasketCode, String rejectedBasketCode, List<OkBasketLst> okBasketLst, Boolean isBulkQty) {
        this.userId = userId;
